...
a persistence unit "Prueba59PersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/ups/edu/ec/Prueba59/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "Prueba59/pom.xml":
...
artifact ("Prueba59.war") is already built. You can build
